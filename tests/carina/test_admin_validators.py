...
def test_validate_voucher_source_correct_validity_days(
    ...
    validate_voucher_source(mock_form, mock_config_field)


def test_validate_voucher_source_empty_validity_days(
    mock_form: mock.MagicMock, mock_config_field: mock.MagicMock
) -> None:
...
def test_validate_voucher_source_empty_validity_days_other_type(
    mock_form: mock.MagicMock, mock_config_field: mock.MagicMock
) -> None:
    mock_form.data = {"validity_days": None}
