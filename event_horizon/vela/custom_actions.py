...
class CampaignEndAction:
    ...
    def _transfer_balance_and_pending_rewards(
        ...
        *,
        ...
        balance_change_activity_payloads: list[dict] | None = None
        ...
        if balance_change_activity_payloads:
            sync_send_list_of_activities(
                balance_change_activity_payloads, routing_key=ActivityType.BALANCE_CHANGE.value
            )
